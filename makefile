...
OBJF = headerpc.o  he3props.o dlinpk.o dwtmeta.o
rg33opt : he4state.o  globmod.o compute_mod.o output_mod.o  input_mod.o  main_win.o \
	  he4props.o $(OBJF) 
	$(FC) $(FFLAGS)   he4state.o globmod.o he4props.o compute_mod.o  \
	input_mod.o  output_mod.o main_win.o $(OBJF) -o rg33opt
main_win.o $(OBJF) input_mod.o  output_mod.o compute_mod.o : globmod.o 
compute_mod.o  : he4props.o
he4props.o  :  he4state.o
main_win.o $(OBJF) input_mod.o  output_mod.o  :   compute_mod.o
input_mod.o : output_mod.o 
main_win.o : input_mod.o
dlinpk.o : dlinpk.f90
